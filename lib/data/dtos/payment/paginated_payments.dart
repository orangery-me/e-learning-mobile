import 'payment_response_dto.dart';

class PaginatedPayments {
  final List<PaymentResponseDto> content;
  ...
  factory PaginatedPayments.fromResponseData(Map<String, dynamic> data) {
    final contentList = (data['content'] as List? ?? const [])
        .map((e) => PaymentResponseDto.fromJson(e as Map<String, dynamic>))
        .toList();
